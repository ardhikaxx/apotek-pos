...
<div class="card border-0 shadow-sm" style="max-width:640px">
    <div class="card-header bg-white d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('apoteker.pos.pdf', $transaction) }}" class="btn btn-sm btn-outline-secondary" target="_blank">
    ...
    <div class="card-body">
        ...
        <a href="{{ route('apoteker.pos') }}" class="btn btn-secondary btn-sm">
            <i class="fa fa-arrow-left me-1"></i>Kembali ke POS
        </a>
    </div>
</div>
@endsection
